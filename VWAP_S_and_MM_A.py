...
class Trader:
    ...
    def run(self, state: TradingState):
        ...
        for product in state.order_depths:
            ...
            if product == "AMETHYSTS": #oscilating one
              ...
              if spread > spread_threshold and highest_bid_price < lowest_ask_price:
                ...
                max_buy_volume = min(order_depth.buy_orders[highest_bid_price], 20)  # Consider maximum position size
                ...
                max_sell_volume = min(-order_depth.sell_orders[lowest_ask_price], 20)  # Consider maximum position size
