...
class Trader:
  ...
  def price_basket_implied(self, state: TradingState):
    return 350 + 4 * self.compute_mid_price(state, "CHOCOLATE") + 6 * self.compute_mid_price(state, "STRAWBERRIES") + self.compute_mid_price(state, "ROSES")
  ...
  def run(self, state: TradingState):
    ...
    for product in state.order_depths:
      ...
      # if product not in ["AMETHYSTS","GIFT_BASKET","ORCHIDS", "CHOCOLATE","STRAWBERRIES", "ROSES"]:
      ...
      if product == "GIFT_BASKET":
        ...
        # update the residual storer 
        self.storer_res.append(self.residual)
        ...
        # BACKTESTING 2:
        # enter: 60 -6k , 20 -14k,
        deviation_enter =  50 # deviation to be optimized 
        deviation_close = 10 # deviation to be optimized
